...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="modal-box p-6 border border-base-content/10 shadow-2xl w-full sm:max-w-sm bg-base-100 animate-in fade-in zoom-in duration-300"
      >
        ...
        <div class="space-y-6">
          ...
          <div class="flex flex-col gap-2">
            <label
              class="text-xs font-bold text-base-content/40 uppercase tracking-widest"
            >
              Año
            </label>
            <div class="flex items-center gap-2">
              <button
                (click)="adjustYear(-1)"
                class="btn btn-square btn-sm btn-ghost border border-base-content/10 hover:bg-primary/10"
              >
                <ngx-icon collection="solar" icon="minus-circle-linear" width="18" height="18" />
              </button>
              <input
                type="number"
              ...
              <button
                ...
                class="btn btn-square btn-sm btn-ghost border border-base-content/10 hover:bg-primary/10"
              >
                <ngx-icon collection="solar" icon="add-circle-linear" width="18" height="18" />
              </button>
            </div>
          </div>
            ...
            <div class="grid grid-cols-3 gap-2">
              @for (month of months; track $index) {
                <button
                  ...
                  class="btn btn-sm font-bold transition-all duration-200"
                >
                  {{ month }}
                </button>
              }
